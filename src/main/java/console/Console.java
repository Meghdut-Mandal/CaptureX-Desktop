...
{	
	...
	private final ArrayList<String> prompts = new ArrayList<>();                // List of previously run commands
   	private ArrayList<String> DOCUMENT_HARDCOPY = new ArrayList<>();      // List of all lines since last cls.
    ...
    public void updateTextPane(String text){
        SwingUtilities.invokeLater(() -> doc.writeUser(text, defaultStyle));
    }
...
//        addMouseWheelListener(this);
    ...
    public void cls() {
        ...
        setDocument(doc);
        doc.setCaret(getCaret());
        DOCUMENT_HARDCOPY = new ArrayList<>();
        DOCUMENT_HARDCOPY.add("");
        currentPosition = 0;
    }
    /*
	...
	public void keyPressed(KeyEvent e)
	{
        ...
        if (e.getKeyCode() == KeyEvent.VK_UP)
        {
            ...
            if (!currentInput.equals("")) { //not sure which one it returns, but it doesn't really matter
